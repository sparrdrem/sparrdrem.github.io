...
Current release: [v1.1.0.0](https://github.com/sparrdrem/sparrdrem-downloader/releases/download/v1.1.0.0/sparrdrem-downloader_v1.1.0.0_setup_x86_english.zip)
...
Cancelled/Discontinued projects are usually projects we will most likely never touch again. Stuff used from these projects may be recycled for newer projects whenever seen fit. Projects that have been discontinued over a year starting this year will be moved [here](cancelled).
...
| :---:                    | :---:                | :---:  | :---:              |
| SYGTVG Debian Installer  | SparrOSDeveloperTeam | Unknown | [Link](https://github.com/sparrdrem/sygtvg-deb)              |
| SYGTVG Windows Installer | SparrOSDeveloperTeam | Unknown | [Link](https://github.com/sparrdrem/sygtvg-win)              |
...
| sparrdrem/laloeda     | Discontinued | [Link](https://launchpad.net/~sparrdrem/laloeda)              |
